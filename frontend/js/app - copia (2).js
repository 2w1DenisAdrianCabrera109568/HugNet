...
const APP_ROUTES = {
  ...
  // --- NUEVA RUTA SPRINT 4 ---
  DONATE_MONEY: { title: "Hacer Donación", icon: "bi-currency-dollar", loader: loadDonateMoneyPage },
  // ---------------------------
  // --- NUEVA RUTA SPRINT 3 ---
...
const ROLE_MENUS = {
  ...
  USUARIO: [APP_ROUTES.DASHBOARD, APP_ROUTES.MY_ACTIVITIES, APP_ROUTES.EXCHANGES, APP_ROUTES.FAQS, APP_ROUTES.ABOUT, APP_ROUTES.CONTACT, APP_ROUTES.PROFILE, APP_ROUTES.DONATE_MONEY],
