...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // Importante para que funcionen los @PreAuthorize en tu Controller
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Report Service no tiene endpoints públicos, todo requiere autenticación previa del Gateway
